...
#Custom Stallion Palette
.stallion3 <- list(
  "1"  = c("black"),
  "2"  = c("#CD2626", "#1874CD"),
  "3"  = c("#CD2626", "#009E73", "#1874CD"),
  "4"  = c("#CD2626", "#009E73", "#1874CD", "#8E0496"),
  "5"  = c("#CD2626", "#E69F00", "#009E73", "#1874CD", "#8E0496"),
  "6"  = c("#CD2626", "#E69F00", "#FFE600", "#009E73", "#1874CD", "#8E0496"),
  "7"  = c("#CD2626", "#E69F00", "#FFE600", "#009E73", "#83A4FF", "#1874CD", "#8E0496"),
  "8"  = c("#CD2626", "#E69F00", "#FFE600", "#009E73", "#83A4FF", "#1874CD", "#8E0496", "#DB65D2"),
  "9"  = c("#CD2626", "#E69F00", "#FFE600", "#009E73", "#75F6FC", "#83A4FF", "#1874CD", "#8E0496", "#DB65D2"),
  "10" = c("#CD2626", "#E69F00", "#FFE600", "#7BE561", "#009E73", "#75F6FC", "#83A4FF", "#1874CD", "#8E0496", "#DB65D2"),
  "11" = c("#FF7D7D", "#CD2626", "#E69F00", "#FFE600", "#7BE561", "#009E73", "#75F6FC", "#83A4FF", "#1874CD", "#8E0496", "#DB65D2"),
  "12" = c("#FF7D7D", "#CD2626", "#E69F00", "#FFE600", "#7BE561", "#009E73", "#75F6FC", "#83A4FF", "#1874CD", "#7C0EDD", "#8E0496", "#DB65D2"),
  "13" = c("#FF7D7D", "#CD2626", "#E69F00", "#FFE600", "#7BE561", "#009E73", "#75F6FC", "#262C6B", "#83A4FF", "#1874CD", "#7C0EDD", "#8E0496", "#DB65D2"),
  "14" = c("#FF7D7D", "#CD2626", "#D34818", "#E69F00", "#FFE600", "#7BE561", "#009E73", "#75F6FC", "#262C6B", "#83A4FF", "#1874CD", "#7C0EDD", "#8E0496", "#DB65D2"),
  "15" = c("#FF7D7D", "#CD2626", "#D34818", "#E69F00", "#FFE600", "#7BE561", "#009E73", "#20C4AC", "#75F6FC", "#262C6B", "#83A4FF", "#1874CD", "#7C0EDD", "#8E0496", "#DB65D2"),
  "16" = c("#FF7D7D", "#CD2626", "#D34818", "#E69F00", "#FFE600", "#7BE561", "#009E73", "#20C4AC", "#75F6FC", "#262C6B", "#83A4FF", "#1874CD", "#A983F2", "#7C0EDD", "#8E0496", "#DB65D2"),
  "17" = c("#FF7D7D", "#CD2626", "#D34818", "#E69F00", "#FFE600", "#7BE561", "#009E73", "#20C4AC", "#75F6FC", "#262C6B", "#83A4FF", "#1874CD", "#A983F2", "#7C0EDD", "#8E0496", "#DB65D2", "#FAC0FF"),
  "18" = c("#FF7D7D", "#CD2626", "#7F0303", "#D34818", "#E69F00", "#FFE600", "#7BE561", "#009E73", "#20C4AC", "#75F6FC", "#262C6B", "#83A4FF", "#1874CD", "#A983F2", "#7C0EDD", "#8E0496", "#DB65D2", "#FAC0FF"),
  "19" = c("#FF7D7D", "#CD2626", "#7F0303", "#D34818", "#E69F00", "#D8A766", "#FFE600", "#7BE561", "#009E73", "#20C4AC", "#75F6FC", "#262C6B", "#83A4FF", "#1874CD", "#A983F2", "#7C0EDD", "#8E0496", "#DB65D2", "#FAC0FF"),
  "20" = c("#FF7D7D", "#CD2626", "#7F0303", "#D34818", "#E69F00", "#D8A766", "#FFE600", "#7BE561", "#009E73", "#20C4AC", "#75F6FC", "#262C6B", "#83A4FF", "#1874CD", "#A983F2", "#7C0EDD", "#8E0496", "#DB65D2", "#FAC0FF", "#969595")
)

#' @export
jg_palettes <- function(){

  #Palette
  pal <- ArchR_palettes_copy

  #Determine if Buencolors Installed
  if(require("BuenColors", quietly = TRUE)){
    pal <- c(
      pal,
      BuenColors::jdb_palettes[!(names(BuenColors::jdb_palettes) %in% names(pal))]
    )
  }

  #Convert Names To CamelCase
  paln <- stringr::str_split(names(pal), pattern="\\_") %>%
    lapply(., function(x){
      if(length(x) == 2){
